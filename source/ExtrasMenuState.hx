...
class ExtrasMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['awards', 'mods', 'credits'];
		...
		for (i in 0...optionShit.length)
			{
				...
				if (firstStart)
					FlxTween.tween(menuItem,{y: 45 + (i * 230)},1 + (i * 0.25) ,{ease: FlxEase.expoInOut, onComplete: function(flxTween:FlxTween) 
						{ 
