...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Reanimated Sprites by'],
			['SereBeat',		'serebeat',		'',						'https://gamebanana.com/members/1819550',	'1c6000'],
			[''],
			['Psych Engine Team'],
		...
		descText.setFormat(Paths.font("minecraft.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
